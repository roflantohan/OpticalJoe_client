...
class RTSPServer(GstRtspServer.RTSPMediaFactory):
    def __init__(self):
        ...
        self.set_launch("( autovideosrc ! videoconvert ! x264enc tune=zerolatency bitrate=1000  speed-preset=ultrafast ! rtph264pay name=pay0 pt=96 )")
...
# gst-launch-1.0 rtspsrc location=rtsp://0.0.0.0:8554/camera latency=0 buffer-mode=auto protocols=udp ! rtph265depay ! h265parse ! avdec_h265 ! videoconvert ! autovideosink
